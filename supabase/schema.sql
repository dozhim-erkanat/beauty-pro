...
-- ---------------------------------------------------------------------
-- Автоматический артикул: пустое поле заполняется как CUT-01042
-- (три буквы бренда + сквозной номер). Подробности — в
-- supabase/migrations/001_auto_sku.sql, там же обратная засыпка.
-- ---------------------------------------------------------------------
-- ---------------------------------------------------------------------
